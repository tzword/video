...
public class JavacvSoundTest {

    public static Runnable recordMicroPhone(int AUDIO_DEVICE_INDEX, String videoPath, int i) {
        /**
         ...
         */
        FFmpegFrameRecorder recorder = new FFmpegFrameRecorder(videoPath,i);
        recorder.setAudioCodecName(videoPath);
